...
const char_arr = [
  ...
  },
  {
    ...
    img: "https://web.archive.org/web/20220811172853/https://static.wikia.nocookie.net/breakingbad/images/7/78/Lydia_S5b.jpg/revision/latest?cb=20130717044258",
    status: "Deceased",
    nickname: "Lydia",
    appearance: [5],
  ...
  res.send(
    ` <div>
        <div>
            ...
            <p>"img": "https://web.archive.org/web/20220811172853/https://images.amcnetworks.com/amc.com/wp-content/uploads/2015/04/cast_bb_700x1000_walter-white-lg.jpg",</p>
            <p>"status": "Presumed dead",</p>
            <p>"nickname": "Heisenberg",</p>
            <p>"appearance": [1, 2, 3, 4, 5],</p>
            <p>"portrayed": "Bryan Cranston",</p>
            <p>"category": "Breaking Bad",</p>
        ...
        <div>
            ...
            <p>{</p>
            <p>"id": 1,</p>
            <p>"quote": "I'm sorry, what were you asking me? Oh, yes, that stupid plastic container I asked you to buy. You see, hydrofluoric acid won't eat through plastic; it will however dissolve metal, rock, glass, ceramic. So there's that",</p>
            <p>"author": "Walter White"</p>
            <p>},</p>
            <p>]</p>
        </div>
    </div>`
